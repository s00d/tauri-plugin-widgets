...
Visual index of the widget IR. Grouped pages explain siblings side by side (e.g. progress vs gauge on [Data](/elements/data)).

<div class="doc-illust">

![Widget IR elements across platforms](/illustrations/concepts.jpg)

</div>

<!-- generated:elements-index — do not edit; run `pnpm docs:generate` -->

Generated from the JSON schema. Prefer the thematic pages for choosing between siblings.

| Element | Tier | Preview |
| --- | --- | --- |
| [`button`](/elements/interactive#el-button) | core | ![button](/shots/desktop/calculator.small.png) |
| [`canvas`](/elements/media#el-canvas) | extended | ![canvas](/shots/desktop/canvas-draws.small.png) |
| [`chart`](/elements/data#el-chart) | extended | ![chart](/shots/desktop/chart-mix.medium.png) |
| [`container`](/elements/layout#el-container) | core | ![container](/shots/desktop/container-card.small.png) |
| [`date`](/elements/text#el-date) | extended | ![date](/shots/desktop/date-timer.medium.png) |
...
| [`vstack`](/elements/layout#el-vstack) | core | ![vstack](/shots/desktop/calculator.small.png) |
| [`zstack`](/elements/layout#el-zstack) | core | ![zstack](/shots/desktop/nested-dashboard.large.png) |
